...
import StudyResultInfo from "./StudyResultInfo";
...
export default function StudyResultCard(studyresult) {
  let {batch_code, credit_sum, semester_gpa, krs_item} = studyresult;
          ...
          <div className="kt-widget26__content">
            ...
            >
              <div style={modalStyle} className={classes.paper}>
                <StudyResultInfo studyResult={krs_item} />
              </div>
            </Modal>
